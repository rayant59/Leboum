                ...
                >
                  ...
                  <div className="mb-2.5 flex items-start justify-between">
                    <span
                      ...
                      style={{ color: c.tint, background: c.tintBg, border: `1px solid ${c.tintBorder}`, boxShadow: sel ? `0 0 16px -4px ${c.tint}` : "none" }}
                    >
                      {c.icon}
                    </span>
